...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-08-2024 a las 23:42:55
...
INSERT INTO `estudiante` (`id_estudiante`, `id_matricula`, `nombre_estudiante`, `apellidos`, `sexo_estudiante`, `nacimiento_estudiante`, `imagen_perfil`, `id_curso`, `id_profesor`, `id_tutor`) VALUES
...
INSERT INTO `profesores` (`id_profesor`, `id_asignatura`, `id_matricula`, `nombre`, `apellidos`, `fecha_nacimiento`, `correo`, `telefono`, `cedula`, `direccion`, `imagen_perfil`) VALUES
...
--
ALTER TABLE `planificacion`
  MODIFY `id_planificacion` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
