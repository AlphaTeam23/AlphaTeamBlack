...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-08-2024 a las 22:34:36
...
CREATE TABLE `estudiante` (
  `id_estudiante` int(5) NOT NULL,
  `id_matricula` varchar(7) COLLATE utf32_spanish2_ci NOT NULL,
...
INSERT INTO `estudiante` (`id_estudiante`, `id_matricula`, `nombre_estudiante`, `apellidos`, `sexo_estudiante`, `nacimiento_estudiante`, `imagen_perfil`, `contraseña`, `id_curso`, `id_profesor`, `id_tutor`) VALUES
...
(15, 2, 1, '1', 'Evaluación Final Python Orientado a Objetos 2024.pdf'),
(16, 2, 1, '1', 'Evaluación Final Python Orientado a Objetos 2024.pdf'),
(17, 2, 1, '1', 'Evaluación Final Python Orientado a Objetos 2024.pdf');
...
CREATE TABLE `profesores` (
  `id_profesor` int(5) NOT NULL,
  `id_asignatura` int(5) NOT NULL,
  `id_matricula` varchar(7) COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `profesores` (`id_profesor`, `id_asignatura`, `id_matricula`, `nombre`, `apellidos`, `fecha_nacimiento`, `correo`, `telefono`, `cedula`, `direccion`, `imagen_perfil`, `contraseña`) VALUES
(1, 3, '0', 'Eduardo Rafael', 'Rodríguez Domínguez', '1968-08-02', 'eduardo@gmail.com', '8294195674', '046-0024666-6', 'Los Llanos de La Herradura, Calle A, #30', '0', ''),
(2, 1, '0', 'Hanyi Gersi', 'Castillo', '1990-08-16', 'hanyigc@gmail.com', '829-633-5649', '130-6575967-6', 'Los Castillos, #21', '0', ''),
(3, 5, '0', 'Jose Luis Manuel', 'Alonzo', '1953-12-06', 'profjosealonzo@gmail.com', '829-55-6545', '046-2285963-6', 'Padre de Las Casas #30', '0', ''),
(4, 6, '0', 'Ruddys', 'Ferreras', '1950-12-10', 'ruddysf@gmail.com', '849-578-8489', '046-2596451-2', 'Villa Olímpica, Calle principal #2', '0', ''),
(5, 7, '0', 'Apolinar', 'Rivas Genao', '1960-04-15', 'apolinar@gmail.com', '829-565-3215', '130-5426315-6', 'La Barranquita, Avenida Olímpica, #12', '0', ''),
(6, 4, '0', 'Jose', 'De La Cruz', '1950-01-16', 'delacruz@gmail.com', '849-424-2424', '046-5526321-6', 'Las Colinas #05', '0', ''),
(7, 2, '0', 'Faustina', 'Rodriguez', '1979-05-04', 'fausrodriguez@gmail.com', '849-478-9863', '130-1548963-9', 'Los Jardines #40', '0', '');
...
ALTER TABLE `estudiante`
  ...
  ADD KEY `id_matricula_e` (`id_matricula`);
...
ALTER TABLE `profesores`
  ...
  ADD KEY `id_asignatura` (`id_asignatura`),
  ADD KEY `id_matricula_p` (`id_matricula`);
...
--
ALTER TABLE `planificacion`
  MODIFY `id_planificacion` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
